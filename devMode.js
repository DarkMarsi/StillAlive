...
function generateTestLocations() {
    ...
    // Вместо создания новых NPC, обновляем существующих
    if (window.NPCS_DB['marcus']) {
        window.NPCS_DB['marcus'].location = 'Аванпост жилой';
    }
    if (window.NPCS_DB['stranger']) {
        window.NPCS_DB['stranger'].location = 'Аванпост жилой';
    }
